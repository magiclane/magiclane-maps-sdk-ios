...
3. In the search bar, enter the repository URL:
   ...
   ```
4. Select **"Up to Next Major Version"** with version **2.1.7**
5. Click **Add Package**
...
**Current Version (2.1.7)**: [Download GEMKit.doccarchive.zip](https://developer.magiclane.com/packages/ios/2.1.7/GEMKit.doccarchive.zip)
